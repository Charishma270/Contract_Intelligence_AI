      ...
      {passwordOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4">
          <div className="w-full max-w-md rounded-3xl bg-white dark:bg-slate-900 p-7 shadow-2xl border border-slate-100 dark:border-slate-800">
            ...
            {passwordError && (
              <div className="mb-4 flex items-start gap-2 rounded-xl bg-red-50 dark:bg-red-900/30 px-4 py-3 text-sm font-semibold text-red-600 dark:text-red-300">
                <AlertCircle size={18} />
            ...
            {passwordSuccess && (
              <div className="mb-4 flex items-start gap-2 rounded-xl bg-green-50 dark:bg-green-900/30 px-4 py-3 text-sm font-semibold text-green-600 dark:text-green-300">
                <CheckCircle size={18} />
            ...
            <div className="mt-6 flex justify-end gap-3">
              <button
                ...
                className="rounded-xl bg-slate-100 dark:bg-slate-800 px-5 py-3 font-semibold text-slate-700 dark:text-white disabled:opacity-60"
              >
                Cancel
              </button>
